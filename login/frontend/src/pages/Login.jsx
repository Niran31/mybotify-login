        ...
        <div className="auth-page">
            <div className="auth-container">
                ...
                <div className="auth-modal">
                    <Link to="/" className="modal-close" aria-label="Close" style={{ textDecoration: 'none' }}>✕</Link>
                    <div className="modal-header">
                        <h2>Welcome to MyBotify</h2>
                        <p className="modal-subtitle">Sign in or create an account to continue</p>
                    </div>
                    ...
                    <form id="loginForm" className="auth-form" onSubmit={handleSubmit}>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                />
                                <span className="input-icon toggle-password">👁️</span>
                            </div>
                        </div>
